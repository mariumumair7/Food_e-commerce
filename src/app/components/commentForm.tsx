...
const CommentForm: React.FC<Props> = ({ postId, onCommentSubmitted }) => {
 ...
 const handleSubmit = async (e: React.FormEvent) => {
    ...
    setError(null);
      ...
      try {
           ...
           setId('');
            onCommentSubmitted();
        } catch (error: unknown) { // Use 'unknown' as a type for the catch block.
            console.error('Error submitting comment:', error);
            setError((error as Error).message || "Failed to submit comment");
        } finally {
